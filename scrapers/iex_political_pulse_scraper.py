"""
Scrape all articles from https://indianexpress.com/section/political-pulse/
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('iex_political_pulse_scraper.log'),
...
OUT_CSV = "data/iex_political_pulse.csv"
CHECKPOINT_FILE = "data/iex_political_pulse_checkpoint.json"
SEEN_URLS_FILE = "data/iex_political_pulse_seen_urls.json"
...
# Regex to identify probable article links (Indian Express Political Pulse articles have /article/political-pulse/ or subcategories in URL)
ARTICLE_RE = re.compile(r"https?://[^/]+/article/political-pulse/.+")  # absolute links for main political pulse articles
SUBCATEGORY_ARTICLE_RE = re.compile(r"https?://[^/]+/article/political-pulse/[^/]+/.+")  # articles in political pulse subcategories
REL_ARTICLE_RE = re.compile(r"/article/political-pulse/.+")           # relative links
    ...
    while True:
        ...
        for article_url in tqdm(sorted(new_links), desc=f"Articles on page {page}"):
            ...
            article_data = {
                "id": article_id,
                "year": year,
                "paper": "Indian Express - Political Pulse",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Scrape Indian Express Political Pulse articles')
