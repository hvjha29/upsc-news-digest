"""
Scrape all articles from https://indianexpress.com/section/explained/
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('iex_scraper.log'),
        logging.StreamHandler(sys.stdout)
    ]
)
logger = logging.getLogger(__name__)

BASE_SECTION = "https://indianexpress.com/section/explained/"
USER_AGENT = "Mozilla/5.0 (compatible; MyScraper/1.0; +https://example.com/bot)"
HEADERS = {"User-Agent": USER_AGENT}
OUT_CSV = "data/iex_explained.csv"
CHECKPOINT_FILE = "data/iex_checkpoint.json"
SEEN_URLS_FILE = "data/iex_seen_urls.json"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Scrape Indian Express Explained articles')
