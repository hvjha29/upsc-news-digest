"""
Scrape articles from The Hindu sections and write to a single CSV with schema:
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('thh_parser.log'),
...
# Configuration
USER_AGENT = "Mozilla/5.0 (compatible; THHParser/1.0; +https://example.com/bot)"
HEADERS = {"User-Agent": USER_AGENT}
OUT_CSV = "data/thh_articles.csv"
CHECKPOINT_FILE = "data/thh_checkpoint.json"
SEEN_URLS_FILE = "data/thh_seen_urls.json"
...
def scrape_sections(urls_file="data/url.md", max_articles_per_section=MAX_ARTICLES_PER_SECTION):
    global shutdown_requested
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Scrape The Hindu articles from multiple sections')
    parser.add_argument('--urls-file', type=str, default='data/url.md',
                        help='File containing URLs to scrape (default: data/url.md)')
