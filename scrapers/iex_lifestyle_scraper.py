"""
Scrape all articles from https://indianexpress.com/section/lifestyle/
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('iex_lifestyle_scraper.log'),
        logging.StreamHandler(sys.stdout)
    ]
)
logger = logging.getLogger(__name__)

BASE_SECTION = "https://indianexpress.com/section/lifestyle/"
USER_AGENT = "Mozilla/0.0 (compatible; MyScraper/1.0; +https://example.com/bot)"
HEADERS = {"User-Agent": USER_AGENT}
OUT_CSV = "data/iex_lifestyle.csv"
CHECKPOINT_FILE = "data/iex_lifestyle_checkpoint.json"
SEEN_URLS_FILE = "data/iex_lifestyle_seen_urls.json"
...
# Regex to identify probable article links (Indian Express Lifestyle articles have /article/lifestyle/ or subcategories in URL)
ARTICLE_RE = re.compile(r"https?://[^/]+/article/lifestyle/.+")  # absolute links for main lifestyle articles
SUBCATEGORY_ARTICLE_RE = re.compile(r"https?://[^/]+/article/lifestyle/[^/]+/.+")  # articles in lifestyle subcategories like health, food-wine, etc.
REL_ARTICLE_RE = re.compile(r"/article/lifestyle/.+")           # relative links
    ...
    while True:
        ...
        for article_url in tqdm(sorted(new_links), desc=f"Articles on page {page}"):
            ...
            article_data = {
                "id": article_id,
                "year": year,
                "paper": "Indian Express - Lifestyle",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Scrape Indian Express Lifestyle articles')
