"""
Scrape all articles from https://indianexpress.com/section/entertainment/
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('iex_entertainment_scraper.log'),
        logging.StreamHandler(sys.stdout)
    ]
)
logger = logging.getLogger(__name__)

BASE_SECTION = "https://indianexpress.com/section/entertainment/"
USER_AGENT = "Mozilla/0.0 (compatible; MyScraper/1.0; +https://example.com/bot)"
HEADERS = {"User-Agent": USER_AGENT}
OUT_CSV = "data/iex_entertainment.csv"
CHECKPOINT_FILE = "data/iex_entertainment_checkpoint.json"
SEEN_URLS_FILE = "data/iex_entertainment_seen_urls.json"
...
# Regex to identify probable article links (Indian Express Entertainment articles have /article/entertainment/ or subcategories in URL)
ARTICLE_RE = re.compile(r"https?://[^/]+/article/entertainment/.+")  # absolute links for main entertainment articles
SUBCATEGORY_ARTICLE_RE = re.compile(r"https?://[^/]+/article/entertainment/[^/]+/.+")  # articles in entertainment subcategories like bollywood, hollywood, etc.
REL_ARTICLE_RE = re.compile(r"/article/entertainment/.+")           # relative links
    ...
    while True:
        ...
        for article_url in tqdm(sorted(new_links), desc=f"Articles on page {page}"):
            ...
            article_data = {
                "id": article_id,
                "year": year,
                "paper": "Indian Express - Entertainment",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Scrape Indian Express Entertainment articles')
