"""
Scrape all articles from https://indianexpress.com/section/sports/
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('iex_sports_scraper.log'),
        logging.StreamHandler(sys.stdout)
    ]
)
logger = logging.getLogger(__name__)

BASE_SECTION = "https://indianexpress.com/section/sports/"
USER_AGENT = "Mozilla/0.0 (compatible; MyScraper/1.0; +https://example.com/bot)"
HEADERS = {"User-Agent": USER_AGENT}
OUT_CSV = "data/iex_sports.csv"
CHECKPOINT_FILE = "data/iex_sports_checkpoint.json"
SEEN_URLS_FILE = "data/iex_sports_seen_urls.json"
...
# Regex to identify probable article links (Indian Express Sports articles have /article/sports/ or subcategories in URL)
ARTICLE_RE = re.compile(r"https?://[^/]+/article/sports/.+")  # absolute links for main sports articles
SUBCATEGORY_ARTICLE_RE = re.compile(r"https?://[^/]+/article/sports/[^/]+/.+")  # articles in sports subcategories like cricket, football, etc.
REL_ARTICLE_RE = re.compile(r"/article/sports/.+")           # relative links
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Scrape Indian Express Sports articles')
