...
def process_pyqs_csv():
    # Process only the specific CSV file
    csv_file = "data/pyqs_pwonly_yes.csv"
    ...
    print(f"Successfully appended data from {csv_file} to {output_file}")
